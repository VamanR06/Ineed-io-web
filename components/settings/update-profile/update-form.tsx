...
export const ProfileForm: React.FC<ProfileFormProps> = ({
  ...
  }, [profile, initialProfile]); // Ensure the dependency array includes only necessary dependencies
  ...
  return (
    <div
      className={cn('flex min-h-screen items-center justify-center bg-gray-100', className)}
      {...props}
    >
